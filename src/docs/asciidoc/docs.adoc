...
==== ✅ REQUEST
include::{snippets}/rest-area-controller-docs/rest-area-search/http-request.adoc[]

==== ✅ REQUEST PARAMETER

include::{snippets}/rest-area-controller-docs/rest-area-search/request-parameters.adoc[]

==== ✅ RESPONSE

include::{snippets}/rest-area-controller-docs/rest-area-search/http-response.adoc[]

==== ✅ RESPONSE FIELD

include::{snippets}/rest-area-controller-docs/rest-area-search/response-fields.adoc[]
